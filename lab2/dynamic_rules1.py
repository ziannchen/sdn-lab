...
class dynamic_rules(app_manager.RyuApp):
    ...
    def get_topology(self, ev):
        ...
        for link in links_list:
            ...
            # self.logger.info("***********************")
            # self.logger.info("src:dpid, port_no, name : %s, %s, %s", str(sw_src), str(src_port), str(src_port_name))
            # self.logger.info("dst:dpid, port_no, name : %s, %s, %s", str(sw_dst), str(dst_port), str(dst_port_name))
            # self.logger.info("***********************")
    ...
    def delete_flow(self, datapath, port):
        ...
        mod = parser.OFPFlowMod(datapath = datapath, 
            out_port = port, out_group = ofproto.OFPG_ANY,
            command = ofproto.OFPFC_DELETE, match = None)
    ...
    def get_OFPPortStatus_msg(self, ev):
        ...
        if reason == ofproto.OFPPR_MODIFY:
            ...
            for dst_port in self.port_name_to_num.values():
                self.delete_flow(datapath = datapath, port = dst_port)
